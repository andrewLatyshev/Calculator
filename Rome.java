...
public enum Rome {
    ...
    XLI(40), XLII(42), XLIII(43), XLIV(44), XLV(45), XLVI(46), XLVII(47), XLVIII(48), XLIX(49), L(50),
    ...
    public static List<Rome> getReverseSortedValues() {
        return Arrays.stream(values())
                .sorted(Comparator.comparing((Rome e) -> e.arabian).reversed())
    ...
    public static String arabicToRoman(int number) {
        ...
        while ((number > 0) && (i < romanNumerals.size())) {
            ...
            if (currentSymbol.getConvertToArabic() <= number) {
                sb.append(currentSymbol.name());
                number -= currentSymbol.getConvertToArabic();
            } else {
                i++;
            }
        }
